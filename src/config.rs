...
use crate::formatter::{Format, EscapeMode, SqlDialect};
...
pub struct Config {
    ...
    pub format: Format,
    #[arg(long, help = "Comma-separated list of fields to output (e.g., domain,path,url)")]
    pub fields: Option<String>,
    #[arg(long, help = "Include header row for tabular formats")]
    pub header: bool,
    #[arg(long, help = "Pretty-print JSON output")]
    pub pretty: bool,
    #[arg(long, value_enum, default_value = "auto", help = "When to use colored output (plain format only)")]
    pub color: ColorMode,
    #[arg(long, default_value = "\\N", help = "Value to print for missing fields in tabular formats")]
    ...
    #[arg(long, help = "Custom format template (e.g., '{scheme}://{domain}{path}')")]
    pub template: Option<String>,
    #[arg(long, value_enum, default_value = "none", help = "Escaping mode for custom format")]
    ...
    #[arg(long, help = "Output results in JSON format (deprecated, use --format json)")]
    pub json: bool,
